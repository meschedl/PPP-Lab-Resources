...
- Use [this protocol](https://docs.google.com/document/d/1uhOCa3ICKb8ETb2zfKHtkPbUfl-1ByZn4xjbabwlHcg/edit?usp=sharing)for picking the size range and enzyme pair to use
...
![](RackMultipart20210813-4-64l2eh_html_e2504531475f6729.png)

**4. DNA Dilution and Initial Cleanup**

- After quantification, determine DNA quantity in each of the samples. You should have already done this in the[choosing enzymes](https://docs.google.com/document/d/1uhOCa3ICKb8ETb2zfKHtkPbUfl-1ByZn4xjbabwlHcg/edit?usp=sharing)step if this is a new library prep. If not, follow below
...
| DNA ng/μl quant | Volume to 500 ng  | Volume 10mM Tris HCl to 50ul |
 |
 |
 |
| --- | --- | --- | --- | --- | --- |
| 75 | 500/75= 6.66μl | 50-6.66= 43.33μl |
 |
 |
 |
...
![](RackMultipart20210813-4-64l2eh_html_b2b5d062cfe96b40.png)
...
![](RackMultipart20210813-4-64l2eh_html_f80a13bc4d9efe5b.png)
...
- Use the [Biotium AccuBlue Plate Reader Protocol](https://github.com/meschedl/PPP-Lab-Resources/blob/master/Protocols/Biotium-BroadRange-DNA-PlateReader.md)
...
- Before starting, calculate how much DNA volume is 100ng for each sample. It can be helpful to put it in a plate format. Choose 1 or 2 samples that have a lot of DNA and use an extra space in the plate layout to do that sample twice. This sample will be for the ligation test. ![](RackMultipart20210813-4-64l2eh_html_ff96f25736616d9b.png)

- Then calculate the volume of10mM Tris HCl up to 31ul for each well (31-volume DNA for 100ng)

![](RackMultipart20210813-4-64l2eh_html_bbbe726ae52eaf09.png)
...
- **Dilute adapters to the working stock concentration for your prep**. Copy this calculator sheet [here](https://docs.google.com/spreadsheets/d/1fcg6mYESNEvi8jfu3T1Bbue-rsVqgeC6RIXjzT9CRrc/edit?hl=en_US&amp;hl=en_US#gid=2) and create a new sheet for your project.
...
![](RackMultipart20210813-4-64l2eh_html_69629ee9334d9294.png)

- Add 2ul of the correct i7 indexes by multichannel pipetting across rows

![](RackMultipart20210813-4-64l2eh_html_b9930af79c1c95e3.png)
...
- UseBR dsDNA Qubit [protoco](https://meschedl.github.io/MESPutnam_Open_Lab_Notebook/Qubit-Protocol/)l. Run this twice, as in re-make the standards and new sample tubes
- Analyze the accuracy of the Pippin Prep and the addition of indexes by running a D5000 TapeStation or D1000 TapeStation on all the samples ([protocol](https://meschedl.github.io/MESPutnam_Open_Lab_Notebook/DNA-Tapestation/))
