...
9. 1X Bead Cleanup after Pooling (if you have multiple plates ready, it is best to pool all plates separately, then cleanup each plate pool at one time together)
